...
CREATE INDEX IF NOT EXISTS push_sent_log_sent_at_idx ON public.push_sent_log(sent_at);
...
DROP POLICY IF EXISTS "Users read own push log" ON public.push_sent_log;
